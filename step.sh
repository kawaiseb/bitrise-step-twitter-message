...
STATUS=$($THIS_SCRIPT_DIR/twitter.js ${tw_debug_mode} ${tw_consumer_key} ${tw_consumer_secret} ${tw_access_token_key} ${tw_access_token_secret} ${tw_screen_name} "${tw_status}")
